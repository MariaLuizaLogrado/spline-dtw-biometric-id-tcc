...
Para reduzir a complexidade computacional, os pontos extraídos nos contornos são submetidos a um processo de simplificação. Estruturas de dados como grafos são utilizadas para armazenar os pontos e suas vizinhanças. A partir desses grafos, é possível aplicar algoritmos para identificação de seus componentes conexos \cite{Scipy}, mantendo aqueles que possuem os maiores nós, ou seja, os pontos mais significativos.
