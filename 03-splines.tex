...
Escrevendo na forma matricial de Hermite, é obitda a seguinte expressão
\begin{equation}
    \vetor{p}(t) =  
        \left(
        \begin{array}{rrrr}
